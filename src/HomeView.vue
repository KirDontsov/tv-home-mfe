  ...
  <div :class="{ 'sm:ml-[64px]': expanded === 'false' }" class="sm:ml-64 p-4 relative top-[78px]">
    <div class="grid grid-cols-2 gap-4 ">
      <div class="flex flex-col gap-2 justify-center mb-4 rounded-sm bg-gray-50 dark:bg-gray-800 px-8 py-4">
        ...
        <select id="selectedCity" v-model="selectedCity"  class="max-w-[500px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      ...
      <div class="flex flex-col gap-2 justify-center mb-4 rounded-sm bg-gray-50 dark:bg-gray-800 px-8 py-4">
        ...
        <select id="selectedCategory" v-model="selectedCategory" class="max-w-[500px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div v-if="(firmsStore.firms?.length > 0 && !firmsStore.firmsLoading)" class="flex px-8 py-4 mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
    ...
    <div v-if="(firmsStore.firms?.length > 0 && !firmsStore.firmsLoading)" class="flex items-center justify-center px-8 py-4 mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
      Pagination
    </div>
  </div>
</template>
