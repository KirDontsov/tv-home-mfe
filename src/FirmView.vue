<template>
  <div
    v-if="selectedFirmStore.firmLoading && !firm"
  ...
  >
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-3">
      <div class="flex flex-col gap-2 px-8 py-4 mb-4 rounded-sm bg-gray-50 dark:bg-gray-700">
        <label for="firm_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Firm Name</label>
        <input
          type="text"
          id="firm_name"
      ...
      <div class="flex flex-col gap-2 px-8 py-4 mb-4 rounded-sm bg-gray-50 dark:bg-gray-700">
        <label for="firm_floor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Firm Floor</label>
        <input
          type="text"
          id="firm_floor"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-x-3">
      ...
      <div class="flex flex-col gap-2 px-8 py-4 mb-4 rounded-sm bg-gray-50 dark:bg-gray-700">
        <label for="firm_site" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Firm Site</label>
        <input
          type="text"
          id="firm_site"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div class="flex flex-col gap-2 justify-center px-8 py-4 mb-4 rounded-sm bg-gray-50 dark:bg-gray-700">
      <label for="firm_title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Firm Title </label>
      <input
        type="text"
        id="firm_title"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
